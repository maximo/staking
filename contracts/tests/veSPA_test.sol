...
/// @title Voting Escrow
/// @notice This contract is for testing purpose (upgrading)
/// @notice totalSupply modified to return 1

contract veSPA_test is IveSPA, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public appendedTestVariable = 1;
    ...
    function _checkpoint(
        ...
        // withdraw: skipped
        // createLock: always go in
        // initiateCooldown: always go in
        // increaseAmount: always go in
        // increaseUnlockTime: always go in
    ...
    function testAssigniing() public {
        appendedTestVariable = 1;
    }
}
